...
//    @Operation(summary = "Изменить баллы роли")
//    public ResponseEntity<UpdatePointsResponseDTO> updateEventRolePoints(
//            @PathVariable Long roleId,
//            @RequestParam Integer points,
//            @RequestParam(required = false) String reason) {
//
//        log.info("PUT /api/events/points/role/{} - Updating points to: {}", roleId, points);
//        UpdatePointsResponseDTO response = participationMarkService.updateEventRolePoints(
//                roleId, points, reason);
//        return ResponseEntity.ok(response);
//    }
